...
{
    private static readonly string[] CustomerNames = ["John Cena", "Randy Orton", "Seth Rollins",
        "CM Punk", "Roman Rigns", "Rey Misterio"];
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                logger.LogWarning("The operation was canceled by the user!");
                break;
            }
            catch (Exception ex)
            {
